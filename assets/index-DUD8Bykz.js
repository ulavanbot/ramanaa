...
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var yI,Io,_I,Ol,Gd,vI,wI,EI;(function(){var t,e=Object.defineProperty;function n(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof cl=="object"&&cl];for(var h=0;h<a.length;++h){var p=a[h];if(p&&p.Math==Math)return p}throw Error("Cannot find global object")}var r=n(this);function i(a,h){if(h)e:{var p=r;a=a.split(".");for(var _=0;_<a.length-1;_++){var O=a[_];if(!(O in p))break e;p=p[O]}a=a[a.length-1],_=p[a],h=h(_),h!=_&&h!=null&&e(p,a,{configurable:!0,writable:!0,value:h})}}i("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(a){return a||function(h){var p=[],_;for(_ in h)Object.prototype.hasOwnProperty.call(h,_)&&p.push([_,h[_]]);return p}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var s=s||{},o=this||self;function l(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function u(a,h,p){return a.call.apply(a.bind,arguments)}function c(a,h,p){return c=u,c.apply(null,arguments)}function d(a,h){var p=Array.prototype.slice.call(arguments,1);return function(){var _=p.slice();return _.push.apply(_,arguments),a.apply(this,_)}}function f(a,h){function p(){}p.prototype=h.prototype,a.Z=h.prototype,a.prototype=new p,a.prototype.constructor=a,a.Ob=function(_,O,L){for(var B=Array(arguments.length-2),Z=2;Z<arguments.length;Z++)B[Z-2]=arguments[Z];return h.prototype[O].apply(_,B)}}var g=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function T(a){const h=a.length;if(h>0){const p=Array(h);for(let _=0;_<h;_++)p[_]=a[_];return p}return[]}function x(a,h){for(let _=1;_<arguments.length;_++){const O=arguments[_];var p=typeof O;if(p=p!="object"?p:O?Array.isArray(O)?"array":p:"null",p=="array"||p=="object"&&typeof O.length=="number"){p=a.length||0;const L=O.length||0;a.length=p+L;for(let B=0;B<L;B++)a[p+B]=O[B]}else a.push(O)}}class k{constructor(h,p){this.i=h,this.j=p,this.h=0,this.g=null}get(){let h;return this.h>0?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function N(a){o.setTimeout(()=>{throw a},0)}function w(){var a=E;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class v{constructor(){this.h=this.g=null}add(h,p){const _=S.get();_.set(h,p),this.h?this.h.next=_:this.g=_,this.h=_}}var S=new k(()=>new b,a=>a.reset());class b{constructor(){this.next=this.g=this.h=null}set(h,p){this.h=h,this.g=p,this.next=null}reset(){this.next=this.g=this.h=null}}let V,F=!1,E=new v,y=()=>{const a=Promise.resolve(void 0);V=()=>{a.then(I)}};function I(){for(var a;a=w();){try{a.h.call(a.g)}catch(p){N(p)}var h=S;h.j(a),h.h<100&&(h.h++,a.next=h.g,h.g=a)}F=!1}function A(){this.u=this.u,this.C=this.C}A.prototype.u=!1,A.prototype.dispose=function(){this.u||(this.u=!0,this.N())},A.prototype[Symbol.dispose]=function(){this.dispose()},A.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function C(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}C.prototype.h=function(){this.defaultPrevented=!0};var D=function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const p=()=>{};o.addEventListener("test",p,h),o.removeEventListener("test",p,h)}catch{}return a}();function R(a){return/^[\s\xa0]*$/.test(a)}function Pe(a,h){C.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,h)}f(Pe,C),Pe.prototype.init=function(a,h){const p=this.type=a.type,_=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget,h||(p=="mouseover"?h=a.fromElement:p=="mouseout"&&(h=a.toElement)),this.relatedTarget=h,_?(this.clientX=_.clientX!==void 0?_.clientX:_.pageX,this.clientY=_.clientY!==void 0?_.clientY:_.pageY,this.screenX=_.screenX||0,this.screenY=_.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&Pe.Z.h.call(this)},Pe.prototype.h=function(){Pe.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var Fe="closure_listenable_"+(Math.random()*1e6|0),Bs=0;function zs(a,h,p,_,O){this.listener=a,this.proxy=null,this.src=h,this.type=p,this.capture=!!_,this.ha=O,this.key=++Bs,this.da=this.fa=!1}function W(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Q(a,h,p){for(const _ in a)h.call(p,a[_],_,a)}function X(a,h){for(const p in a)h.call(void 0,a[p],p,a)}function ge(a){const h={};for(const p in a)h[p]=a[p];return h}const Ae="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Hr(a,h){let p,_;for(let O=1;O<arguments.length;O++){_=arguments[O];for(p in _)a[p]=_[p];for(let L=0;L<Ae.length;L++)p=Ae[L],Object.prototype.hasOwnProperty.call(_,p)&&(a[p]=_[p])}}function Dt(a){this.src=a,this.g={},this.h=0}Dt.prototype.add=function(a,h,p,_,O){const L=a.toString();a=this.g[L],a||(a=this.g[L]=[],this.h++);const B=Wt(a,h,_,O);return B>-1?(h=a[B],p||(h.fa=!1)):(h=new zs(h,this.src,L,!!_,O),h.fa=p,a.push(h)),h};function qr(a,h){const p=h.type;if(p in a.g){var _=a.g[p],O=Array.prototype.indexOf.call(_,h,void 0),L;(L=O>=0)&&Array.prototype.splice.call(_,O,1),L&&(W(h),a.g[p].length==0&&(delete a.g[p],a.h--))}}function Wt(a,h,p,_){for(let O=0;O<a.length;++O){const L=a[O];if(!L.da&&L.listener==h&&L.capture==!!p&&L.ha==_)return O}return-1}var Yn="closure_lm_"+(Math.random()*1e6|0),Nc={};function dm(a,h,p,_,O){if(Array.isArray(h)){for(let L=0;L<h.length;L++)dm(a,h[L],p,_,O);return null}return p=mm(p),a&&a[Fe]?a.J(h,p,l(_)?!!_.capture:!1,O):oS(a,h,p,!1,_,O)}function oS(a,h,p,_,O,L){if(!h)throw Error("Invalid event type");const B=l(O)?!!O.capture:!!O;let Z=bc(a);if(Z||(a[Yn]=Z=new Dt(a)),p=Z.add(h,p,_,B,L),p.proxy)return p;if(_=aS(),p.proxy=_,_.src=a,_.listener=p,a.addEventListener)D||(O=B),O===void 0&&(O=!1),a.addEventListener(h.toString(),_,O);else if(a.attachEvent)a.attachEvent(pm(h.toString()),_);else if(a.addListener&&a.removeListener)a.addListener(_);else throw Error("addEventListener and attachEvent are unavailable.");return p}function aS(){function a(p){return h.call(a.src,a.listener,p)}const h=lS;return a}function fm(a,h,p,_,O){if(Array.isArray(h))for(var L=0;L<h.length;L++)fm(a,h[L],p,_,O);else _=l(_)?!!_.capture:!!_,p=mm(p),a&&a[Fe]?(a=a.i,L=String(h).toString(),L in a.g&&(h=a.g[L],p=Wt(h,p,_,O),p>-1&&(W(h[p]),Array.prototype.splice.call(h,p,1),h.length==0&&(delete a.g[L],a.h--)))):a&&(a=bc(a))&&(h=a.g[h.toString()],a=-1,h&&(a=Wt(h,p,_,O)),(p=a>-1?h[a]:null)&&Dc(p))}function Dc(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[Fe])qr(h.i,a);else{var p=a.type,_=a.proxy;h.removeEventListener?h.removeEventListener(p,_,a.capture):h.detachEvent?h.detachEvent(pm(p),_):h.addListener&&h.removeListener&&h.removeListener(_),(p=bc(h))?(qr(p,a),p.h==0&&(p.src=null,h[Yn]=null)):W(a)}}}function pm(a){return a in Nc?Nc[a]:Nc[a]="on"+a}function lS(a,h){if(a.da)a=!0;else{h=new Pe(h,this);const p=a.listener,_=a.ha||a.src;a.fa&&Dc(a),a=p.call(_,h)}return a}function bc(a){return a=a[Yn],a instanceof Dt?a:null}var Oc="__closure_events_fn_"+(Math.random()*1e9>>>0);function mm(a){return typeof a=="function"?a:(a[Oc]||(a[Oc]=function(h){return a.handleEvent(h)}),a[Oc])}function Ye(){A.call(this),this.i=new Dt(this),this.M=this,this.G=null}f(Ye,A),Ye.prototype[Fe]=!0,Ye.prototype.removeEventListener=function(a,h,p,_){fm(this,a,h,p,_)};function st(a,h){var p,_=a.G;if(_)for(p=[];_;_=_.G)p.push(_);if(a=a.M,_=h.type||h,typeof h=="string")h=new C(h,a);else if(h instanceof C)h.target=h.target||a;else{var O=h;h=new C(_,a),Hr(h,O)}O=!0;let L,B;if(p)for(B=p.length-1;B>=0;B--)L=h.g=p[B],O=ba(L,_,!0,h)&&O;if(L=h.g=a,O=ba(L,_,!0,h)&&O,O=ba(L,_,!1,h)&&O,p)for(B=0;B<p.length;B++)L=h.g=p[B],O=ba(L,_,!1,h)&&O}Ye.prototype.N=function(){if(Ye.Z.N.call(this),this.i){var a=this.i;for(const h in a.g){const p=a.g[h];for(let _=0;_<p.length;_++)W(p[_]);delete a.g[h],a.h--}}this.G=null},Ye.prototype.J=function(a,h,p,_){return this.i.add(String(a),h,!1,p,_)},Ye.prototype.K=function(a,h,p,_){return this.i.add(String(a),h,!0,p,_)};function ba(a,h,p,_){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();let O=!0;for(let L=0;L<h.length;++L){const B=h[L];if(B&&!B.da&&B.capture==p){const Z=B.listener,Le=B.ha||B.src;B.fa&&qr(a.i,B),O=Z.call(Le,_)!==!1&&O}}return O&&!_.defaultPrevented}function uS(a,h){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=c(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(h)>2147483647?-1:o.setTimeout(a,h||0)}function gm(a){a.g=uS(()=>{a.g=null,a.i&&(a.i=!1,gm(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class cS extends A{constructor(h,p){super(),this.m=h,this.l=p,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:gm(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function $s(a){A.call(this),this.h=a,this.g={}}f($s,A);var ym=[];function _m(a){Q(a.g,function(h,p){this.g.hasOwnProperty(p)&&Dc(h)},a),a.g={}}$s.prototype.N=function(){$s.Z.N.call(this),_m(this)},$s.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Lc=o.JSON.stringify,hS=o.JSON.parse,dS=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function vm(){}function wm(){}var Ws={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Vc(){C.call(this,"d")}f(Vc,C);function Mc(){C.call(this,"c")}f(Mc,C);var Kr={},Em=null;function Oa(){return Em=Em||new Ye}Kr.Ia="serverreachability";function Tm(a){C.call(this,Kr.Ia,a)}f(Tm,C);function Hs(a){const h=Oa();st(h,new Tm(h))}Kr.STAT_EVENT="statevent";function Im(a,h){C.call(this,Kr.STAT_EVENT,a),this.stat=h}f(Im,C);function ot(a){const h=Oa();st(h,new Im(h,a))}Kr.Ja="timingevent";function Sm(a,h){C.call(this,Kr.Ja,a),this.size=h}f(Sm,C);function qs(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},h)}function Ks(){this.g=!0}Ks.prototype.ua=function(){this.g=!1};function fS(a,h,p,_,O,L){a.info(function(){if(a.g)if(L){var B="",Z=L.split("&");for(let le=0;le<Z.length;le++){var Le=Z[le].split("=");if(Le.length>1){const Ue=Le[0];Le=Le[1];const un=Ue.split("_");B=un.length>=2&&un[1]=="type"?B+(Ue+"="+Le+"&"):B+(Ue+"=redacted&")}}}else B=null;else B=L;return"XMLHTTP REQ ("+_+") [attempt "+O+"]: "+h+`
`+p+`
`+B})}function pS(a,h,p,_,O,L,B){a.info(function(){return"XMLHTTP RESP ("+_+") [ attempt "+O+"]: "+h+`
`+p+`
`+L+" "+B})}function bi(a,h,p,_){a.info(function(){return"XMLHTTP TEXT ("+h+"): "+gS(a,p)+(_?" "+_:"")})}function mS(a,h){a.info(function(){return"TIMEOUT: "+h})}Ks.prototype.info=function(){};function gS(a,h){if(!a.g)return h;if(!h)return null;try{const L=JSON.parse(h);if(L){for(a=0;a<L.length;a++)if(Array.isArray(L[a])){var p=L[a];if(!(p.length<2)){var _=p[1];if(Array.isArray(_)&&!(_.length<1)){var O=_[0];if(O!="noop"&&O!="stop"&&O!="close")for(let B=1;B<_.length;B++)_[B]=""}}}}return Lc(L)}catch{return h}}var La={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Rm={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Am;function jc(){}f(jc,vm),jc.prototype.g=function(){return new XMLHttpRequest},Am=new jc;function Gs(a){return encodeURIComponent(String(a))}function yS(a){var h=1;a=a.split(":");const p=[];for(;h>0&&a.length;)p.push(a.shift()),h--;return a.length&&p.push(a.join(":")),p}function Jn(a,h,p,_){this.j=a,this.i=h,this.l=p,this.S=_||1,this.V=new $s(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Cm}function Cm(){this.i=null,this.g="",this.h=!1}var xm={},Fc={};function Uc(a,h,p){a.M=1,a.A=Ma(ln(h)),a.u=p,a.R=!0,km(a,null)}function km(a,h){a.F=Date.now(),Va(a),a.B=ln(a.A);var p=a.B,_=a.S;Array.isArray(_)||(_=[String(_)]),zm(p.i,"t",_),a.C=0,p=a.j.L,a.h=new Cm,a.g=og(a.j,p?h:null,!a.u),a.P>0&&(a.O=new cS(c(a.Y,a,a.g),a.P)),h=a.V,p=a.g,_=a.ba;var O="readystatechange";Array.isArray(O)||(O&&(ym[0]=O.toString()),O=ym);for(let L=0;L<O.length;L++){const B=dm(p,O[L],_||h.handleEvent,!1,h.h||h);if(!B)break;h.g[B.key]=B}h=a.J?ge(a.J):{},a.u?(a.v||(a.v="POST"),h["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,h)):(a.v="GET",a.g.ea(a.B,a.v,null,h)),Hs(),fS(a.i,a.v,a.B,a.l,a.S,a.u)}Jn.prototype.ba=function(a){a=a.target;const h=this.O;h&&er(a)==3?h.j():this.Y(a)},Jn.prototype.Y=function(a){try{if(a==this.g)e:{const Z=er(this.g),Le=this.g.ya(),le=this.g.ca();if(!(Z<3)&&(Z!=3||this.g&&(this.h.h||this.g.la()||Qm(this.g)))){this.K||Z!=4||Le==7||(Le==8||le<=0?Hs(3):Hs(2)),Bc(this);var h=this.g.ca();this.X=h;var p=_S(this);if(this.o=h==200,pS(this.i,this.v,this.B,this.l,this.S,Z,h),this.o){if(this.U&&!this.L){t:{if(this.g){var _,O=this.g;if((_=O.g?O.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!R(_)){var L=_;break t}}L=null}if(a=L)bi(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,zc(this,a);else{this.o=!1,this.m=3,ot(12),Gr(this),Qs(this);break e}}if(this.R){a=!0;let Ue;for(;!this.K&&this.C<p.length;)if(Ue=vS(this,p),Ue==Fc){Z==4&&(this.m=4,ot(14),a=!1),bi(this.i,this.l,null,"[Incomplete Response]");break}else if(Ue==xm){this.m=4,ot(15),bi(this.i,this.l,p,"[Invalid Chunk]"),a=!1;break}else bi(this.i,this.l,Ue,null),zc(this,Ue);if(Pm(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Z!=4||p.length!=0||this.h.h||(this.m=1,ot(16),a=!1),this.o=this.o&&a,!a)bi(this.i,this.l,p,"[Invalid Chunked Response]"),Gr(this),Qs(this);else if(p.length>0&&!this.W){this.W=!0;var B=this.j;B.g==this&&B.aa&&!B.P&&(B.j.info("Great, no buffering proxy detected. Bytes received: "+p.length),Yc(B),B.P=!0,ot(11))}}else bi(this.i,this.l,p,null),zc(this,p);Z==4&&Gr(this),this.o&&!this.K&&(Z==4?ng(this.j,this):(this.o=!1,Va(this)))}else bS(this.g),h==400&&p.indexOf("Unknown SID")>0?(this.m=3,ot(12)):(this.m=0,ot(13)),Gr(this),Qs(this)}}}catch{}finally{}};function _S(a){if(!Pm(a))return a.g.la();const h=Qm(a.g);if(h==="")return"";let p="";const _=h.length,O=er(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return Gr(a),Qs(a),"";a.h.i=new o.TextDecoder}for(let L=0;L<_;L++)a.h.h=!0,p+=a.h.i.decode(h[L],{stream:!(O&&L==_-1)});return h.length=0,a.h.g+=p,a.C=0,a.h.g}function Pm(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function vS(a,h){var p=a.C,_=h.indexOf(`
`,p);return _==-1?Fc:(p=Number(h.substring(p,_)),isNaN(p)?xm:(_+=1,_+p>h.length?Fc:(h=h.slice(_,_+p),a.C=_+p,h)))}Jn.prototype.cancel=function(){this.K=!0,Gr(this)};function Va(a){a.T=Date.now()+a.H,Nm(a,a.H)}function Nm(a,h){if(a.D!=null)throw Error("WatchDog timer not null");a.D=qs(c(a.aa,a),h)}function Bc(a){a.D&&(o.clearTimeout(a.D),a.D=null)}Jn.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(mS(this.i,this.B),this.M!=2&&(Hs(),ot(17)),Gr(this),this.m=2,Qs(this)):Nm(this,this.T-a)};function Qs(a){a.j.I==0||a.K||ng(a.j,a)}function Gr(a){Bc(a);var h=a.O;h&&typeof h.dispose=="function"&&h.dispose(),a.O=null,_m(a.V),a.g&&(h=a.g,a.g=null,h.abort(),h.dispose())}function zc(a,h){try{var p=a.j;if(p.I!=0&&(p.g==a||$c(p.h,a))){if(!a.L&&$c(p.h,a)&&p.I==3){try{var _=p.Ba.g.parse(h)}catch{_=null}if(Array.isArray(_)&&_.length==3){var O=_;if(O[0]==0){e:if(!p.v){if(p.g)if(p.g.F+3e3<a.F)za(p),Ua(p);else break e;Qc(p),ot(18)}}else p.xa=O[1],0<p.xa-p.K&&O[2]<37500&&p.F&&p.A==0&&!p.C&&(p.C=qs(c(p.Va,p),6e3));Om(p.h)<=1&&p.ta&&(p.ta=void 0)}else Yr(p,11)}else if((a.L||p.g==a)&&za(p),!R(h))for(O=p.Ba.g.parse(h),h=0;h<O.length;h++){let le=O[h];const Ue=le[0];if(!(Ue<=p.K))if(p.K=Ue,le=le[1],p.I==2)if(le[0]=="c"){p.M=le[1],p.ba=le[2];const un=le[3];un!=null&&(p.ka=un,p.j.info("VER="+p.ka));const Jr=le[4];Jr!=null&&(p.za=Jr,p.j.info("SVER="+p.za));const tr=le[5];tr!=null&&typeof tr=="number"&&tr>0&&(_=1.5*tr,p.O=_,p.j.info("backChannelRequestTimeoutMs_="+_)),_=p;const nr=a.g;if(nr){const Wa=nr.g?nr.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Wa){var L=_.h;L.g||Wa.indexOf("spdy")==-1&&Wa.indexOf("quic")==-1&&Wa.indexOf("h2")==-1||(L.j=L.l,L.g=new Set,L.h&&(Wc(L,L.h),L.h=null))}if(_.G){const Jc=nr.g?nr.g.getResponseHeader("X-HTTP-Session-Id"):null;Jc&&(_.wa=Jc,he(_.J,_.G,Jc))}}p.I=3,p.l&&p.l.ra(),p.aa&&(p.T=Date.now()-a.F,p.j.info("Handshake RTT: "+p.T+"ms")),_=p;var B=a;if(_.na=sg(_,_.L?_.ba:null,_.W),B.L){Lm(_.h,B);var Z=B,Le=_.O;Le&&(Z.H=Le),Z.D&&(Bc(Z),Va(Z)),_.g=B}else eg(_);p.i.length>0&&Ba(p)}else le[0]!="stop"&&le[0]!="close"||Yr(p,7);else p.I==3&&(le[0]=="stop"||le[0]=="close"?le[0]=="stop"?Yr(p,7):Gc(p):le[0]!="noop"&&p.l&&p.l.qa(le),p.A=0)}}Hs(4)}catch{}}var wS=class{constructor(a,h){this.g=a,this.map=h}};function Dm(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function bm(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function Om(a){return a.h?1:a.g?a.g.size:0}function $c(a,h){return a.h?a.h==h:a.g?a.g.has(h):!1}function Wc(a,h){a.g?a.g.add(h):a.h=h}function Lm(a,h){a.h&&a.h==h?a.h=null:a.g&&a.g.has(h)&&a.g.delete(h)}Dm.prototype.cancel=function(){if(this.i=Vm(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Vm(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let h=a.i;for(const p of a.g.values())h=h.concat(p.G);return h}return T(a.i)}var Mm=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ES(a,h){if(a){a=a.split("&");for(let p=0;p<a.length;p++){const _=a[p].indexOf("=");let O,L=null;_>=0?(O=a[p].substring(0,_),L=a[p].substring(_+1)):O=a[p],h(O,L?decodeURIComponent(L.replace(/\+/g," ")):"")}}}function Xn(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let h;a instanceof Xn?(this.l=a.l,Ys(this,a.j),this.o=a.o,this.g=a.g,Js(this,a.u),this.h=a.h,Hc(this,$m(a.i)),this.m=a.m):a&&(h=String(a).match(Mm))?(this.l=!1,Ys(this,h[1]||"",!0),this.o=Xs(h[2]||""),this.g=Xs(h[3]||"",!0),Js(this,h[4]),this.h=Xs(h[5]||"",!0),Hc(this,h[6]||"",!0),this.m=Xs(h[7]||"")):(this.l=!1,this.i=new eo(null,this.l))}Xn.prototype.toString=function(){const a=[];var h=this.j;h&&a.push(Zs(h,jm,!0),":");var p=this.g;return(p||h=="file")&&(a.push("//"),(h=this.o)&&a.push(Zs(h,jm,!0),"@"),a.push(Gs(p).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),p=this.u,p!=null&&a.push(":",String(p))),(p=this.h)&&(this.g&&p.charAt(0)!="/"&&a.push("/"),a.push(Zs(p,p.charAt(0)=="/"?SS:IS,!0))),(p=this.i.toString())&&a.push("?",p),(p=this.m)&&a.push("#",Zs(p,AS)),a.join("")},Xn.prototype.resolve=function(a){const h=ln(this);let p=!!a.j;p?Ys(h,a.j):p=!!a.o,p?h.o=a.o:p=!!a.g,p?h.g=a.g:p=a.u!=null;var _=a.h;if(p)Js(h,a.u);else if(p=!!a.h){if(_.charAt(0)!="/")if(this.g&&!this.h)_="/"+_;else{var O=h.h.lastIndexOf("/");O!=-1&&(_=h.h.slice(0,O+1)+_)}if(O=_,O==".."||O==".")_="";else if(O.indexOf("./")!=-1||O.indexOf("/.")!=-1){_=O.lastIndexOf("/",0)==0,O=O.split("/");const L=[];for(let B=0;B<O.length;){const Z=O[B++];Z=="."?_&&B==O.length&&L.push(""):Z==".."?((L.length>1||L.length==1&&L[0]!="")&&L.pop(),_&&B==O.length&&L.push("")):(L.push(Z),_=!0)}_=L.join("/")}else _=O}return p?h.h=_:p=a.i.toString()!=="",p?Hc(h,$m(a.i)):p=!!a.m,p&&(h.m=a.m),h};function ln(a){return new Xn(a)}function Ys(a,h,p){a.j=p?Xs(h,!0):h,a.j&&(a.j=a.j.replace(/:$/,""))}function Js(a,h){if(h){if(h=Number(h),isNaN(h)||h<0)throw Error("Bad port number "+h);a.u=h}else a.u=null}function Hc(a,h,p){h instanceof eo?(a.i=h,CS(a.i,a.l)):(p||(h=Zs(h,RS)),a.i=new eo(h,a.l))}function he(a,h,p){a.i.set(h,p)}function Ma(a){return he(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function Xs(a,h){return a?h?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Zs(a,h,p){return typeof a=="string"?(a=encodeURI(a).replace(h,TS),p&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function TS(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var jm=/[#\/\?@]/g,IS=/[#\?:]/g,SS=/[#\?]/g,RS=/[#\?@]/g,AS=/#/g;function eo(a,h){this.h=this.g=null,this.i=a||null,this.j=!!h}function Qr(a){a.g||(a.g=new Map,a.h=0,a.i&&ES(a.i,function(h,p){a.add(decodeURIComponent(h.replace(/\+/g," ")),p)}))}t=eo.prototype,t.add=function(a,h){Qr(this),this.i=null,a=Oi(this,a);let p=this.g.get(a);return p||this.g.set(a,p=[]),p.push(h),this.h+=1,this};function Fm(a,h){Qr(a),h=Oi(a,h),a.g.has(h)&&(a.i=null,a.h-=a.g.get(h).length,a.g.delete(h))}function Um(a,h){return Qr(a),h=Oi(a,h),a.g.has(h)}t.forEach=function(a,h){Qr(this),this.g.forEach(function(p,_){p.forEach(function(O){a.call(h,O,_,this)},this)},this)};function Bm(a,h){Qr(a);let p=[];if(typeof h=="string")Um(a,h)&&(p=p.concat(a.g.get(Oi(a,h))));else for(a=Array.from(a.g.values()),h=0;h<a.length;h++)p=p.concat(a[h]);return p}t.set=function(a,h){return Qr(this),this.i=null,a=Oi(this,a),Um(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[h]),this.h+=1,this},t.get=function(a,h){return a?(a=Bm(this,a),a.length>0?String(a[0]):h):h};function zm(a,h,p){Fm(a,h),p.length>0&&(a.i=null,a.g.set(Oi(a,h),T(p)),a.h+=p.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],h=Array.from(this.g.keys());for(let _=0;_<h.length;_++){var p=h[_];const O=Gs(p);p=Bm(this,p);for(let L=0;L<p.length;L++){let B=O;p[L]!==""&&(B+="="+Gs(p[L])),a.push(B)}}return this.i=a.join("&")};function $m(a){const h=new eo;return h.i=a.i,a.g&&(h.g=new Map(a.g),h.h=a.h),h}function Oi(a,h){return h=String(h),a.j&&(h=h.toLowerCase()),h}function CS(a,h){h&&!a.j&&(Qr(a),a.i=null,a.g.forEach(function(p,_){const O=_.toLowerCase();_!=O&&(Fm(this,_),zm(this,O,p))},a)),a.j=h}function xS(a,h){const p=new Ks;if(o.Image){const _=new Image;_.onload=d(Zn,p,"TestLoadImage: loaded",!0,h,_),_.onerror=d(Zn,p,"TestLoadImage: error",!1,h,_),_.onabort=d(Zn,p,"TestLoadImage: abort",!1,h,_),_.ontimeout=d(Zn,p,"TestLoadImage: timeout",!1,h,_),o.setTimeout(function(){_.ontimeout&&_.ontimeout()},1e4),_.src=a}else h(!1)}function kS(a,h){const p=new Ks,_=new AbortController,O=setTimeout(()=>{_.abort(),Zn(p,"TestPingServer: timeout",!1,h)},1e4);fetch(a,{signal:_.signal}).then(L=>{clearTimeout(O),L.ok?Zn(p,"TestPingServer: ok",!0,h):Zn(p,"TestPingServer: server error",!1,h)}).catch(()=>{clearTimeout(O),Zn(p,"TestPingServer: error",!1,h)})}function Zn(a,h,p,_,O){try{O&&(O.onload=null,O.onerror=null,O.onabort=null,O.ontimeout=null),_(p)}catch{}}function PS(){this.g=new dS}function qc(a){this.i=a.Sb||null,this.h=a.ab||!1}f(qc,vm),qc.prototype.g=function(){return new ja(this.i,this.h)};function ja(a,h){Ye.call(this),this.H=a,this.o=h,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}f(ja,Ye),t=ja.prototype,t.open=function(a,h){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=h,this.readyState=1,no(this)},t.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const h={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(h.body=a),(this.H||o).fetch(new Request(this.D,h)).then(this.Pa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,to(this)),this.readyState=0},t.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,no(this)),this.g&&(this.readyState=3,no(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Wm(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function Wm(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}t.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var h=a.value?a.value:new Uint8Array(0);(h=this.B.decode(h,{stream:!a.done}))&&(this.response=this.responseText+=h)}a.done?to(this):no(this),this.readyState==3&&Wm(this)}},t.Oa=function(a){this.g&&(this.response=this.responseText=a,to(this))},t.Na=function(a){this.g&&(this.response=a,to(this))},t.ga=function(){this.g&&to(this)};function to(a){a.readyState=4,a.l=null,a.j=null,a.B=null,no(a)}t.setRequestHeader=function(a,h){this.A.append(a,h)},t.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],h=this.h.entries();for(var p=h.next();!p.done;)p=p.value,a.push(p[0]+": "+p[1]),p=h.next();return a.join(`\r
`)};function no(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(ja.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Hm(a){let h="";return Q(a,function(p,_){h+=_,h+=":",h+=p,h+=`\r
`}),h}function Kc(a,h,p){e:{for(_ in p){var _=!1;break e}_=!0}_||(p=Hm(p),typeof a=="string"?p!=null&&Gs(p):he(a,h,p))}function Ie(a){Ye.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}f(Ie,Ye);var NS=/^https?$/i,DS=["POST","PUT"];t=Ie.prototype,t.Fa=function(a){this.H=a},t.ea=function(a,h,p,_){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);h=h?h.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Am.g(),this.g.onreadystatechange=g(c(this.Ca,this));try{this.B=!0,this.g.open(h,String(a),!0),this.B=!1}catch(L){qm(this,L);return}if(a=p||"",p=new Map(this.headers),_)if(Object.getPrototypeOf(_)===Object.prototype)for(var O in _)p.set(O,_[O]);else if(typeof _.keys=="function"&&typeof _.get=="function")for(const L of _.keys())p.set(L,_.get(L));else throw Error("Unknown input type for opt_headers: "+String(_));_=Array.from(p.keys()).find(L=>L.toLowerCase()=="content-type"),O=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(DS,h,void 0)>=0)||_||O||p.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[L,B]of p)this.g.setRequestHeader(L,B);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(L){qm(this,L)}};function qm(a,h){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=h,a.o=5,Km(a),Fa(a)}function Km(a){a.A||(a.A=!0,st(a,"complete"),st(a,"error"))}t.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,st(this,"complete"),st(this,"abort"),Fa(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Fa(this,!0)),Ie.Z.N.call(this)},t.Ca=function(){this.u||(this.B||this.v||this.j?Gm(this):this.Xa())},t.Xa=function(){Gm(this)};function Gm(a){if(a.h&&typeof s<"u"){if(a.v&&er(a)==4)setTimeout(a.Ca.bind(a),0);else if(st(a,"readystatechange"),er(a)==4){a.h=!1;try{const L=a.ca();e:switch(L){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var h=!0;break e;default:h=!1}var p;if(!(p=h)){var _;if(_=L===0){let B=String(a.D).match(Mm)[1]||null;!B&&o.self&&o.self.location&&(B=o.self.location.protocol.slice(0,-1)),_=!NS.test(B?B.toLowerCase():"")}p=_}if(p)st(a,"complete"),st(a,"success");else{a.o=6;try{var O=er(a)>2?a.g.statusText:""}catch{O=""}a.l=O+" ["+a.ca()+"]",Km(a)}}finally{Fa(a)}}}}function Fa(a,h){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const p=a.g;a.g=null,h||st(a,"ready");try{p.onreadystatechange=null}catch{}}}t.isActive=function(){return!!this.g};function er(a){return a.g?a.g.readyState:0}t.ca=function(){try{return er(this)>2?this.g.status:-1}catch{return-1}},t.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.La=function(a){if(this.g){var h=this.g.responseText;return a&&h.indexOf(a)==0&&(h=h.substring(a.length)),hS(h)}};function Qm(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function bS(a){const h={};a=(a.g&&er(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let _=0;_<a.length;_++){if(R(a[_]))continue;var p=yS(a[_]);const O=p[0];if(p=p[1],typeof p!="string")continue;p=p.trim();const L=h[O]||[];h[O]=L,L.push(p)}X(h,function(_){return _.join(", ")})}t.ya=function(){return this.o},t.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function ro(a,h,p){return p&&p.internalChannelParams&&p.internalChannelParams[a]||h}function Ym(a){this.za=0,this.i=[],this.j=new Ks,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=ro("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=ro("baseRetryDelayMs",5e3,a),this.Za=ro("retryDelaySeedMs",1e4,a),this.Ta=ro("forwardChannelMaxRetries",2,a),this.va=ro("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new Dm(a&&a.concurrentRequestLimit),this.Ba=new PS,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}t=Ym.prototype,t.ka=8,t.I=1,t.connect=function(a,h,p,_){ot(0),this.W=a,this.H=h||{},p&&_!==void 0&&(this.H.OSID=p,this.H.OAID=_),this.F=this.X,this.J=sg(this,null,this.W),Ba(this)};function Gc(a){if(Jm(a),a.I==3){var h=a.V++,p=ln(a.J);if(he(p,"SID",a.M),he(p,"RID",h),he(p,"TYPE","terminate"),io(a,p),h=new Jn(a,a.j,h),h.M=2,h.A=Ma(ln(p)),p=!1,o.navigator&&o.navigator.sendBeacon)try{p=o.navigator.sendBeacon(h.A.toString(),"")}catch{}!p&&o.Image&&(new Image().src=h.A,p=!0),p||(h.g=og(h.j,null),h.g.ea(h.A)),h.F=Date.now(),Va(h)}ig(a)}function Ua(a){a.g&&(Yc(a),a.g.cancel(),a.g=null)}function Jm(a){Ua(a),a.v&&(o.clearTimeout(a.v),a.v=null),za(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function Ba(a){if(!bm(a.h)&&!a.m){a.m=!0;var h=a.Ea;V||y(),F||(V(),F=!0),E.add(h,a),a.D=0}}function OS(a,h){return Om(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=h.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=qs(c(a.Ea,a,h),rg(a,a.D)),a.D++,!0)}t.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const O=new Jn(this,this.j,a);let L=this.o;if(this.U&&(L?(L=ge(L),Hr(L,this.U)):L=this.U),this.u!==null||this.R||(O.J=L,L=null),this.S)e:{for(var h=0,p=0;p<this.i.length;p++){t:{var _=this.i[p];if("__data__"in _.map&&(_=_.map.__data__,typeof _=="string")){_=_.length;break t}_=void 0}if(_===void 0)break;if(h+=_,h>4096){h=p;break e}if(h===4096||p===this.i.length-1){h=p+1;break e}}h=1e3}else h=1e3;h=Zm(this,O,h),p=ln(this.J),he(p,"RID",a),he(p,"CVER",22),this.G&&he(p,"X-HTTP-Session-Id",this.G),io(this,p),L&&(this.R?h="headers="+Gs(Hm(L))+"&"+h:this.u&&Kc(p,this.u,L)),Wc(this.h,O),this.Ra&&he(p,"TYPE","init"),this.S?(he(p,"$req",h),he(p,"SID","null"),O.U=!0,Uc(O,p,null)):Uc(O,p,h),this.I=2}}else this.I==3&&(a?Xm(this,a):this.i.length==0||bm(this.h)||Xm(this))};function Xm(a,h){var p;h?p=h.l:p=a.V++;const _=ln(a.J);he(_,"SID",a.M),he(_,"RID",p),he(_,"AID",a.K),io(a,_),a.u&&a.o&&Kc(_,a.u,a.o),p=new Jn(a,a.j,p,a.D+1),a.u===null&&(p.J=a.o),h&&(a.i=h.G.concat(a.i)),h=Zm(a,p,1e3),p.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),Wc(a.h,p),Uc(p,_,h)}function io(a,h){a.H&&Q(a.H,function(p,_){he(h,_,p)}),a.l&&Q({},function(p,_){he(h,_,p)})}function Zm(a,h,p){p=Math.min(a.i.length,p);const _=a.l?c(a.l.Ka,a.l,a):null;e:{var O=a.i;let Z=-1;for(;;){const Le=["count="+p];Z==-1?p>0?(Z=O[0].g,Le.push("ofs="+Z)):Z=0:Le.push("ofs="+Z);let le=!0;for(let Ue=0;Ue<p;Ue++){var L=O[Ue].g;const un=O[Ue].map;if(L-=Z,L<0)Z=Math.max(0,O[Ue].g-100),le=!1;else try{L="req"+L+"_"||"";try{var B=un instanceof Map?un:Object.entries(un);for(const[Jr,tr]of B){let nr=tr;l(tr)&&(nr=Lc(tr)),Le.push(L+Jr+"="+encodeURIComponent(nr))}}catch(Jr){throw Le.push(L+"type="+encodeURIComponent("_badmap")),Jr}}catch{_&&_(un)}}if(le){B=Le.join("&");break e}}B=void 0}return a=a.i.splice(0,p),h.G=a,B}function eg(a){if(!a.g&&!a.v){a.Y=1;var h=a.Da;V||y(),F||(V(),F=!0),E.add(h,a),a.A=0}}function Qc(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=qs(c(a.Da,a),rg(a,a.A)),a.A++,!0)}t.Da=function(){if(this.v=null,tg(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=qs(c(this.Wa,this),a)}},t.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ot(10),Ua(this),tg(this))};function Yc(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function tg(a){a.g=new Jn(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var h=ln(a.na);he(h,"RID","rpc"),he(h,"SID",a.M),he(h,"AID",a.K),he(h,"CI",a.F?"0":"1"),!a.F&&a.ia&&he(h,"TO",a.ia),he(h,"TYPE","xmlhttp"),io(a,h),a.u&&a.o&&Kc(h,a.u,a.o),a.O&&(a.g.H=a.O);var p=a.g;a=a.ba,p.M=1,p.A=Ma(ln(h)),p.u=null,p.R=!0,km(p,a)}t.Va=function(){this.C!=null&&(this.C=null,Ua(this),Qc(this),ot(19))};function za(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function ng(a,h){var p=null;if(a.g==h){za(a),Yc(a),a.g=null;var _=2}else if($c(a.h,h))p=h.G,Lm(a.h,h),_=1;else return;if(a.I!=0){if(h.o)if(_==1){p=h.u?h.u.length:0,h=Date.now()-h.F;var O=a.D;_=Oa(),st(_,new Sm(_,p)),Ba(a)}else eg(a);else if(O=h.m,O==3||O==0&&h.X>0||!(_==1&&OS(a,h)||_==2&&Qc(a)))switch(p&&p.length>0&&(h=a.h,h.i=h.i.concat(p)),O){case 1:Yr(a,5);break;case 4:Yr(a,10);break;case 3:Yr(a,6);break;default:Yr(a,2)}}}function rg(a,h){let p=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(p*=2),p*h}function Yr(a,h){if(a.j.info("Error code "+h),h==2){var p=c(a.bb,a),_=a.Ua;const O=!_;_=new Xn(_||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||Ys(_,"https"),Ma(_),O?xS(_.toString(),p):kS(_.toString(),p)}else ot(2);a.I=0,a.l&&a.l.pa(h),ig(a),Jm(a)}t.bb=function(a){a?(this.j.info("Successfully pinged google.com"),ot(2)):(this.j.info("Failed to ping google.com"),ot(1))};function ig(a){if(a.I=0,a.ja=[],a.l){const h=Vm(a.h);(h.length!=0||a.i.length!=0)&&(x(a.ja,h),x(a.ja,a.i),a.h.i.length=0,T(a.i),a.i.length=0),a.l.oa()}}function sg(a,h,p){var _=p instanceof Xn?ln(p):new Xn(p);if(_.g!="")h&&(_.g=h+"."+_.g),Js(_,_.u);else{var O=o.location;_=O.protocol,h=h?h+"."+O.hostname:O.hostname,O=+O.port;const L=new Xn(null);_&&Ys(L,_),h&&(L.g=h),O&&Js(L,O),p&&(L.h=p),_=L}return p=a.G,h=a.wa,p&&h&&he(_,p,h),he(_,"VER",a.ka),io(a,_),_}function og(a,h,p){if(h&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return h=a.Aa&&!a.ma?new Ie(new qc({ab:p})):new Ie(a.ma),h.Fa(a.L),h}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function ag(){}t=ag.prototype,t.ra=function(){},t.qa=function(){},t.pa=function(){},t.oa=function(){},t.isActive=function(){return!0},t.Ka=function(){};function $a(){}$a.prototype.g=function(a,h){return new Et(a,h)};function Et(a,h){Ye.call(this),this.g=new Ym(h),this.l=a,this.h=h&&h.messageUrlParams||null,a=h&&h.messageHeaders||null,h&&h.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=h&&h.initMessageHeaders||null,h&&h.messageContentType&&(a?a["X-WebChannel-Content-Type"]=h.messageContentType:a={"X-WebChannel-Content-Type":h.messageContentType}),h&&h.sa&&(a?a["X-WebChannel-Client-Profile"]=h.sa:a={"X-WebChannel-Client-Profile":h.sa}),this.g.U=a,(a=h&&h.Qb)&&!R(a)&&(this.g.u=a),this.A=h&&h.supportsCrossDomainXhr||!1,this.v=h&&h.sendRawJson||!1,(h=h&&h.httpSessionIdParam)&&!R(h)&&(this.g.G=h,a=this.h,a!==null&&h in a&&(a=this.h,h in a&&delete a[h])),this.j=new Li(this)}f(Et,Ye),Et.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},Et.prototype.close=function(){Gc(this.g)},Et.prototype.o=function(a){var h=this.g;if(typeof a=="string"){var p={};p.__data__=a,a=p}else this.v&&(p={},p.__data__=Lc(a),a=p);h.i.push(new wS(h.Ya++,a)),h.I==3&&Ba(h)},Et.prototype.N=function(){this.g.l=null,delete this.j,Gc(this.g),delete this.g,Et.Z.N.call(this)};function lg(a){Vc.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var h=a.__sm__;if(h){e:{for(const p in h){a=p;break e}a=void 0}(this.i=a)&&(a=this.i,h=h!==null&&a in h?h[a]:void 0),this.data=h}else this.data=a}f(lg,Vc);function ug(){Mc.call(this),this.status=1}f(ug,Mc);function Li(a){this.g=a}f(Li,ag),Li.prototype.ra=function(){st(this.g,"a")},Li.prototype.qa=function(a){st(this.g,new lg(a))},Li.prototype.pa=function(a){st(this.g,new ug)},Li.prototype.oa=function(){st(this.g,"b")},$a.prototype.createWebChannel=$a.prototype.g,Et.prototype.send=Et.prototype.o,Et.prototype.open=Et.prototype.m,Et.prototype.close=Et.prototype.close,EI=function(){return new $a},wI=function(){return Oa()},vI=Kr,Gd={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},La.NO_ERROR=0,La.TIMEOUT=8,La.HTTP_ERROR=6,Ol=La,Rm.COMPLETE="complete",_I=Rm,wm.EventType=Ws,Ws.OPEN="a",Ws.CLOSE="b",Ws.ERROR="c",Ws.MESSAGE="d",Ye.prototype.listen=Ye.prototype.J,Io=wm,Ie.prototype.listenOnce=Ie.prototype.K,Ie.prototype.getLastError=Ie.prototype.Ha,Ie.prototype.getLastErrorCode=Ie.prototype.ya,Ie.prototype.getStatus=Ie.prototype.ca,Ie.prototype.getResponseJson=Ie.prototype.La,Ie.prototype.getResponseText=Ie.prototype.la,Ie.prototype.send=Ie.prototype.ea,Ie.prototype.setWithCredentials=Ie.prototype.Fa,yI=Ie}).apply(typeof cl<"u"?cl:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rS="storage";function EV(t=oc(),e){t=Re(t);const r=Ur(t,rS).getImmediate({identifier:e}),i=nT("storage");return i&&TV(r,...i),r}function TV(t,e,n,r={}){vV(t,e,n,r)}function IV(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new wV(n,r,i,e,Ci)}function SV(){nn(new zt(rS,IV,"PUBLIC").setMultipleInstances(!0)),wt(mv,gv,""),wt(mv,gv,"esm2020")}SV();const RV={apiKey:"AIzaSyCz-Se6FAY2q0vv92mvoyCfSmhPGzJg7Oc",authDomain:"ramanaa-de432.firebaseapp.com",projectId:"ramanaa-de432",storageBucket:"ramanaa-de432.firebasestorage.app",messagingSenderId:"693947373642",appId:"1:693947373642:web:3178828f7798597cb7aeb3",measurementId:"G-KZ5QGCQ942"},kc=dT(RV);sN(kc);const fr=ID(kc),pn=PL(kc);EV(kc);const Qn=P.createContext(),AV=({children:t})=>{const[e,n]=P.useState(null),[r,i]=P.useState(!0),o=(e==null?void 0:e.email)==="murthythiru97@gmail.com";P.useEffect(()=>{if(fr.app.options.apiKey==="YOUR_API_KEY"){console.warn("Firebase is not configured! Please add your config to src/firebase.js"),i(!1);return}return h2(fr,f=>{n(f),i(!1)})},[]);const l=(d,f)=>a2(fr,d,f),u=(d,f)=>l2(fr,d,f),c=()=>d2(fr);return m.jsx(Qn.Provider,{value:{currentUser:e,isAdmin:o,login:u,signup:l,logout:c,loading:r},children:!r&&t})},Us=P.createContext(),CV=({children:t})=>{const[e,n]=P.useState([]),[r,i]=P.useState(!1);P.useEffect(()=>{const g=localStorage.getItem("ramanaa_cart");g&&n(JSON.parse(g))},[]),P.useEffect(()=>{localStorage.setItem("ramanaa_cart",JSON.stringify(e))},[e]);const s=g=>{n(T=>T.find(k=>k.id===g.id)?T.map(k=>k.id===g.id?{...k,quantity:k.quantity+1}:k):[...T,{...g,quantity:1}]),i(!0)},o=g=>{n(T=>T.filter(x=>x.id!==g))},l=(g,T)=>{n(x=>x.map(k=>{if(k.id===g){const N=k.quantity+T;return N>0?{...k,quantity:N}:k}return k}))},u=()=>{n([])},c=e.reduce((g,T)=>g+T.price*T.quantity,0),d=e.reduce((g,T)=>g+T.quantity,0),f=()=>i(!r);return m.jsx(Us.Provider,{value:{cartItems:e,isCartOpen:r,addToCart:s,removeFromCart:o,updateQuantity:l,clearCart:u,cartTotal:c,cartCount:d,toggleCart:f,setIsCartOpen:i},children:t})},iS=P.createContext(),xV=({children:t})=>{const[e,n]=P.useState("light");P.useEffect(()=>{const i=localStorage.getItem("ramanaa_theme");i?(n(i),document.documentElement.setAttribute("data-theme",i)):window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(n("dark"),document.documentElement.setAttribute("data-theme","dark"))},[]);const r=()=>{const i=e==="light"?"dark":"light";n(i),localStorage.setItem("ramanaa_theme",i),document.documentElement.setAttribute("data-theme",i)};return m.jsx(iS.Provider,{value:{theme:e,toggleTheme:r},children:t})},kV=()=>{const[t,e]=P.useState(!1),{currentUser:n,isAdmin:r,logout:i}=P.useContext(Qn),{cartCount:s,toggleCart:o}=P.useContext(Us),{theme:l,toggleTheme:u}=P.useContext(iS),c=Ri(),d=()=>{e(!t)},f=async()=>{try{await i(),c("/login")}catch(g){console.error("Failed to log out",g)}};return m.jsx("nav",{className:"navbar",children:m.jsxs("div",{className:"container navbar-container",children:[m.jsxs(fe,{to:"/",className:"navbar-logo",children:["Ramanaa",m.jsx("span",{children:"."})]}),m.jsxs("div",{className:`navbar-menu ${t?"active":""}`,children:[m.jsx(fe,{to:"/",className:"nav-link",onClick:()=>e(!1),children:"Home"}),m.jsx(fe,{to:"/shop",className:"nav-link",onClick:()=>e(!1),children:"Shop"}),n&&!r&&m.jsx(fe,{to:"/profile",className:"nav-link",onClick:()=>e(!1),children:"My Profile"}),r&&m.jsx(fe,{to:"/admin",className:"nav-link",onClick:()=>e(!1),style:{color:"var(--primary-color)",fontWeight:"bold"},children:"Admin Dashboard"})]}),m.jsxs("div",{className:"navbar-actions",children:[m.jsx("button",{className:"icon-btn theme-toggle-btn",onClick:u,"aria-label":"Toggle Theme",title:"Toggle Theme",style:{marginRight:"10px"},children:l==="light"?m.jsx(Z1,{size:22}):m.jsx(Q1,{size:22})}),n?m.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[m.jsxs("span",{style:{fontSize:"0.9rem",color:"var(--text-muted)"},className:"hide-on-mobile",children:["Hi, ",n.email.split("@")[0]]}),m.jsx("button",{className:"icon-btn",onClick:f,"aria-label":"Log Out",title:"Log Out",children:m.jsx(nx,{size:20})})]}):m.jsx(fe,{to:"/login",className:"icon-btn","aria-label":"Sign In",title:"Sign In",children:m.jsx(K1,{size:22})}),m.jsxs("button",{className:"icon-btn cart-btn",onClick:o,"aria-label":"Shopping Cart",children:[m.jsx(Y1,{size:22}),s>0&&m.jsx("span",{className:"cart-badge",children:s})]}),m.jsx("button",{className:"mobile-menu-btn",onClick:d,"aria-label":"Toggle Menu",children:t?m.jsx(JE,{size:26}):m.jsx(tx,{size:26})})]})]})})},hm=P.createContext(),go={description:"Premium traditional wear for the modern man. Owned by A P KARTHIK.",email:"info@ramanaa.com",phone:"+91 98765 43210"},PV=({children:t})=>{const[e,n]=P.useState(go),r=fr.app.options.apiKey!=="YOUR_API_KEY";P.useEffect(()=>{r?(async()=>{try{const l=await KL(ui(pn,"store","settings"));l.exists()?n(l.data()):(await hv(ui(pn,"store","settings"),go),n(go))}catch(l){console.error("Error fetching settings:",l),i()}})():i()},[]);const i=()=>{const o=localStorage.getItem("ramanaa_settings");o?n(JSON.parse(o)):(n(go),localStorage.setItem("ramanaa_settings",JSON.stringify(go)))},s=async o=>{if(r)try{await hv(ui(pn,"store","settings"),o),n(o)}catch(l){console.error("Error updating settings:",l)}else n(o),localStorage.setItem("ramanaa_settings",JSON.stringify(o))};return m.jsx(hm.Provider,{value:{settings:e,updateSettings:s},children:t})},NV=()=>{const{settings:t}=P.useContext(hm);return m.jsxs("footer",{className:"footer",children:[m.jsxs("div",{className:"container footer-container",children:[m.jsxs("div",{className:"footer-col",children:[m.jsxs("h2",{className:"footer-logo",children:["Ramanaa",m.jsx("span",{children:"."})]}),m.jsx("p",{className:"footer-desc",children:t.description})]}),m.jsxs("div",{className:"footer-col",children:[m.jsx("h3",{className:"footer-title",children:"Quick Links"}),m.jsxs("ul",{className:"footer-links",children:[m.jsx("li",{children:m.jsx(fe,{to:"/",children:"Home"})}),m.jsx("li",{children:m.jsx(fe,{to:"/shop",children:"Shop Collection"})}),m.jsx("li",{children:m.jsx(fe,{to:"#about",children:"About Us"})}),m.jsx("li",{children:m.jsx(fe,{to:"#contact",children:"Contact"})})]})]}),m.jsxs("div",{className:"footer-col",children:[m.jsx("h3",{className:"footer-title",children:"Categories"}),m.jsxs("ul",{className:"footer-links",children:[m.jsx("li",{children:m.jsx(fe,{to:"/shop?category=dhotis",children:"Pure Cotton Dhotis"})}),m.jsx("li",{children:m.jsx(fe,{to:"/shop?category=shirts",children:"Traditional Shirts"})}),m.jsx("li",{children:m.jsx(fe,{to:"/shop?category=wedding",children:"Wedding Collection"})}),m.jsx("li",{children:m.jsx(fe,{to:"/shop?category=accessories",children:"Accessories"})})]})]}),m.jsxs("div",{className:"footer-col",children:[m.jsx("h3",{className:"footer-title",children:"Contact Us"}),m.jsx("p",{className:"footer-contact",children:t.email}),m.jsx("p",{className:"footer-contact",children:t.phone})]})]}),m.jsx("div",{className:"footer-bottom",children:m.jsxs("p",{children:["© ",new Date().getFullYear()," Ramanaa by A P KARTHIK. All rights reserved."]})})]})},DV=()=>m.jsx("section",{className:"hero",children:m.jsxs("div",{className:"hero-content",children:[m.jsx("h1",{className:"hero-title",children:"Elegance in Tradition"}),m.jsx("p",{className:"hero-subtitle",children:"Discover Ramanaa's premium collection of pure cotton and silk dhotis, crafted for the modern man who values heritage."}),m.jsxs("div",{className:"hero-actions",children:[m.jsx(fe,{to:"/shop",className:"btn-primary",children:"Shop Collection"}),m.jsx(fe,{to:"#about",className:"btn-secondary",children:"Our Story"})]})]})}),sS=({id:t,image:e,title:n,price:r,category:i,reviews:s})=>{const{addToCart:o}=P.useContext(Us),l=()=>{o({id:t,image:e,title:n,price:r,category:i})},u=s&&s.length>0?(s.reduce((c,d)=>c+d.rating,0)/s.length).toFixed(1):null;return m.jsxs("div",{className:"product-card",children:[m.jsxs(fe,{to:`/product/${t}`,className:"product-image-container",style:{display:"block"},children:[m.jsx("img",{src:e,alt:n,className:"product-image"}),m.jsx("div",{className:"product-overlay",children:m.jsx("button",{className:"btn-primary overlay-btn",children:"Quick View"})})]}),m.jsxs("div",{className:"product-info",children:[m.jsx("span",{className:"product-category",children:i}),m.jsx("h3",{className:"product-title",children:n}),u&&m.jsxs("div",{className:"product-rating",style:{color:"var(--secondary-color)",fontSize:"0.9rem",marginBottom:"5px"},children:["★ ",u," ",m.jsxs("span",{style:{color:"var(--text-muted)",fontSize:"0.8rem"},children:["(",s.length,")"]})]}),m.jsxs("p",{className:"product-price",children:["₹",r]}),m.jsx("button",{className:"add-to-cart-btn",onClick:l,children:"Add to Cart"})]})]})},Ul="/ramanaa/assets/dhoti-CPDPBGJ-.png",Mi="/ramanaa/assets/shirt-k9jthzXz.png",$h=[{id:1,title:"Premium White Shirt - Special Edition",price:1999,category:"Shirts",image:Mi},{id:2,title:"Premium Pure Silk Dhoti - Special Edition",price:4999,category:"Dhotis",image:Ul},{id:3,title:"Full Hand Formal White Shirt",price:1299,category:"Shirts",image:Mi},{id:4,title:"Half Hand Traditional Shirt",price:899,category:"Shirts",image:Mi},{id:5,title:"Coloured Shirt - Deep Maroon",price:1199,category:"Shirts",image:Mi},{id:6,title:"Coloured Shirt - Navy Blue",price:1199,category:"Shirts",image:Mi},{id:7,title:"Classic Gold Border Dhoti",price:999,category:"Dhotis",image:Ul},{id:8,title:"Cotton Blend Everyday Dhoti",price:699,category:"Dhotis",image:Ul},{id:9,title:"Premium Mens Cotton Inners (Pack of 3)",price:599,category:"Accessories",image:Mi}],Da=P.createContext(),bV=({children:t})=>{const[e,n]=P.useState([]),r=fr.app.options.apiKey!=="YOUR_API_KEY";P.useEffect(()=>{r?(async()=>{try{const d=(await X0(Lu(pn,"products"))).docs.map(f=>({id:f.id,...f.data()}));d.length>0?n(d):n($h)}catch(c){console.error("Error fetching products:",c),i()}})():i()},[]);const i=()=>{const u=localStorage.getItem("ramanaa_products_v2");u?n(JSON.parse(u)):(n($h),localStorage.setItem("ramanaa_products_v2",JSON.stringify($h)))},s=async u=>{if(r)try{const c=await eS(Lu(pn,"products"),{...u,reviews:[]});n([{id:c.id,...u,reviews:[]},...e])}catch(c){throw console.error("Error adding document: ",c),c}else{const d=[{...u,id:Date.now(),reviews:[]},...e];n(d),localStorage.setItem("ramanaa_products_v2",JSON.stringify(d))}},o=async u=>{if(r)try{await GL(ui(pn,"products",u)),n(e.filter(c=>c.id!==u))}catch(c){throw console.error("Error deleting document: ",c),c}else{const c=e.filter(d=>d.id!==u);n(c),localStorage.setItem("ramanaa_products_v2",JSON.stringify(c))}},l=async(u,c)=>{if(r)try{const d=ui(pn,"products",u);await Z0(d,{reviews:BL(c)}),n(e.map(f=>f.id===u?{...f,reviews:[...f.reviews||[],c]}:f))}catch(d){throw console.error("Error adding review: ",d),d}else{const d=e.map(f=>f.id===u?{...f,reviews:[...f.reviews||[],c]}:f);n(d),localStorage.setItem("ramanaa_products_v2",JSON.stringify(d))}};return m.jsx(Da.Provider,{value:{products:e,addProduct:s,deleteProduct:o,addReview:l},children:t})},OV=()=>{const{products:t}=P.useContext(Da),e=t.slice(0,4);return m.jsxs("div",{className:"home-page",children:[m.jsx(DV,{}),m.jsx("section",{className:"section-padding",style:{backgroundColor:"var(--bg-white)"},children:m.jsxs("div",{className:"container",children:[m.jsxs("div",{className:"text-center",children:[m.jsx("h2",{className:"section-title",children:"Featured Collection"}),m.jsx("p",{style:{color:"var(--text-muted)",marginBottom:"40px"},children:"Handpicked premium traditional wear for your special occasions."})]}),m.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(250px, 1fr))",gap:"30px"},children:e.map(n=>m.jsx(sS,{...n},n.id))})]})}),m.jsx("section",{id:"about",className:"section-padding",style:{backgroundColor:"var(--bg-light)"},children:m.jsx("div",{className:"container",children:m.jsxs("div",{style:{display:"flex",flexWrap:"wrap",alignItems:"center",gap:"40px"},children:[m.jsx("div",{style:{flex:"1 1 400px"},children:m.jsx("img",{src:Ul,alt:"About Ramanaa",style:{width:"100%",borderRadius:"8px",boxShadow:"var(--shadow-lg)"}})}),m.jsxs("div",{style:{flex:"1 1 400px"},children:[m.jsx("h2",{className:"section-title",style:{textAlign:"left",margin:"0 0 20px 0"},children:"About The Brand"}),m.jsx("h3",{style:{fontSize:"1.5rem",marginBottom:"15px",color:"var(--secondary-color)"},children:"Ramanaa by A P KARTHIK"}),m.jsx("p",{style:{marginBottom:"15px",fontSize:"1.1rem",color:"var(--text-muted)"},children:"Founded with a vision to preserve and elevate traditional Indian menswear, Ramanaa brings you the finest quality dhotis and shirts."}),m.jsx("p",{style:{marginBottom:"25px",color:"var(--text-muted)"},children:"Every piece in our collection is crafted with meticulous attention to detail, ensuring comfort without compromising on elegance. A P Karthik's dedication to quality makes Ramanaa the preferred choice for those who value authentic traditional aesthetics."}),m.jsx("button",{className:"btn-primary",children:"Read More"})]})]})})})]})},LV=()=>{const{products:t}=P.useContext(Da),[e,n]=P.useState("All"),[r,i]=P.useState(""),[s,o]=P.useState(5e3),l=["All","Dhotis","Shirts","Accessories"],u=t.filter(c=>{const d=e==="All"||c.category===e,f=c.title.toLowerCase().includes(r.toLowerCase()),g=c.price<=s;return d&&f&&g});return m.jsx("div",{className:"shop-page",style:{paddingTop:"100px",minHeight:"100vh",backgroundColor:"var(--bg-light)"},children:m.jsxs("div",{className:"container",children:[m.jsxs("div",{className:"text-center",style:{marginBottom:"40px"},children:[m.jsx("h1",{className:"section-title",children:"Our Collection"}),m.jsx("p",{style:{color:"var(--text-muted)"},children:"Browse our premium selection of traditional wear"})]}),m.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"20px",marginBottom:"40px"},children:[m.jsxs("div",{style:{position:"relative",width:"100%",maxWidth:"400px"},children:[m.jsx(J1,{style:{position:"absolute",top:"50%",left:"15px",transform:"translateY(-50%)",color:"var(--text-muted)"}}),m.jsx("input",{type:"text",placeholder:"Search products...",value:r,onChange:c=>i(c.target.value),style:{width:"100%",padding:"12px 15px 12px 40px",borderRadius:"30px",border:"1px solid var(--border-color)",outline:"none",backgroundColor:"var(--bg-white)",color:"var(--text-dark)",fontFamily:"var(--font-body)"}})]}),m.jsxs("div",{style:{width:"100%",maxWidth:"400px",textAlign:"center"},children:[m.jsxs("label",{style:{color:"var(--text-muted)",fontSize:"0.9rem",display:"block",marginBottom:"5px"},children:["Max Price: ",m.jsxs("strong",{children:["₹",s]})]}),m.jsx("input",{type:"range",min:"100",max:"5000",step:"100",value:s,onChange:c=>o(c.target.value),style:{width:"100%"}})]}),m.jsx("div",{style:{display:"flex",justifyContent:"center",flexWrap:"wrap",gap:"10px"},children:l.map(c=>m.jsx("button",{className:e===c?"btn-primary":"btn-secondary",onClick:()=>n(c),style:{padding:"8px 16px",borderRadius:"20px",fontSize:"0.9rem"},children:c},c))})]}),m.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(250px, 1fr))",gap:"30px",paddingBottom:"80px"},children:u.length>0?u.map(c=>m.jsx(sS,{...c},c.id)):m.jsxs("div",{style:{gridColumn:"1 / -1",textAlign:"center",padding:"50px",color:"var(--text-muted)"},children:[m.jsx("h3",{children:"No products found matching your criteria."}),m.jsx("button",{className:"btn-secondary",onClick:()=>{i(""),o(5e3),n("All")},style:{marginTop:"15px"},children:"Clear Filters"})]})})]})})},Pc=P.createContext(),VV=({children:t})=>{const[e,n]=P.useState([]),[r,i]=P.useState(!0),s=fr.app.options.apiKey!=="YOUR_API_KEY";P.useEffect(()=>{s?o():i(!1)},[]);const o=async()=>{try{const c=WL(Lu(pn,"orders"),HL("date","desc")),f=(await X0(c)).docs.map(g=>({id:g.id,...g.data()}));n(f)}catch(c){console.error("Error fetching orders:",c)}finally{i(!1)}},l=async c=>{if(!s){console.warn("Firebase not configured. Order not saved.");return}try{const d=await eS(Lu(pn,"orders"),{...c,date:new Date().toISOString(),status:"Pending"});return n([{id:d.id,...c,date:new Date().toISOString(),status:"Pending"},...e]),d.id}catch(d){throw console.error("Error placing order: ",d),d}},u=async(c,d)=>{if(s)try{const f=ui(pn,"orders",c);await Z0(f,{status:d}),n(e.map(g=>g.id===c?{...g,status:d}:g))}catch(f){throw console.error("Error updating order status: ",f),f}};return m.jsx(Pc.Provider,{value:{orders:e,loading:r,placeOrder:l,updateOrderStatus:u},children:t})},MV=()=>{const{products:t,addProduct:e,deleteProduct:n}=P.useContext(Da),{settings:r,updateSettings:i}=P.useContext(hm),{orders:s,loading:o,updateOrderStatus:l}=P.useContext(Pc),[u,c]=P.useState("orders"),[d,f]=P.useState({title:"",price:"",category:"Dhotis"}),[g,T]=P.useState(null),[x,k]=P.useState(!1),N=y=>{f({...d,[y.target.name]:y.target.value})},w=y=>{y.target.files[0]&&T(y.target.files[0])},v=y=>new Promise((I,A)=>{const C=new FileReader;C.readAsDataURL(y),C.onload=()=>{I(C.result)},C.onerror=D=>{A(D)}}),S=async y=>{if(y.preventDefault(),!d.title||!d.price||!g)return alert("Please fill out title, price, and select an image!");k(!0);try{const I=await v(g),A={title:d.title,price:parseInt(d.price),category:d.category,image:I};await e(A),f({title:"",price:"",category:"Dhotis"}),T(null),document.getElementById("productImageInput").value="",alert("Product added successfully!")}catch(I){console.error(I),alert("Error adding product! "+I.message)}finally{k(!1)}},[b,V]=P.useState(r),F=y=>{V({...b,[y.target.name]:y.target.value})},E=y=>{y.preventDefault(),i(b),alert("Store settings updated successfully!")};return m.jsx("div",{className:"admin-page section-padding",children:m.jsxs("div",{className:"container",children:[m.jsx("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"30px"},children:m.jsx("h1",{className:"section-title",style:{marginBottom:0},children:"Admin Dashboard"})}),m.jsxs("div",{className:"admin-tabs",style:{display:"flex",gap:"15px",marginBottom:"30px",borderBottom:"2px solid var(--bg-light)",paddingBottom:"10px"},children:[m.jsx("button",{className:`admin-tab-btn ${u==="orders"?"active":""}`,onClick:()=>c("orders"),style:{background:"none",border:"none",fontSize:"1.2rem",fontWeight:"bold",color:u==="orders"?"var(--primary-color)":"var(--text-muted)",cursor:"pointer"},children:"Orders"}),m.jsx("button",{className:`admin-tab-btn ${u==="products"?"active":""}`,onClick:()=>c("products"),style:{background:"none",border:"none",fontSize:"1.2rem",fontWeight:"bold",color:u==="products"?"var(--primary-color)":"var(--text-muted)",cursor:"pointer"},children:"Products"}),m.jsx("button",{className:`admin-tab-btn ${u==="settings"?"active":""}`,onClick:()=>c("settings"),style:{background:"none",border:"none",fontSize:"1.2rem",fontWeight:"bold",color:u==="settings"?"var(--primary-color)":"var(--text-muted)",cursor:"pointer"},children:"Settings"})]}),u==="orders"&&m.jsxs("div",{className:"admin-card",children:[m.jsx("h2",{children:"Recent Orders"}),o?m.jsx("p",{children:"Loading orders..."}):s.length===0?m.jsx("p",{children:"No orders yet."}):m.jsx("div",{className:"product-list-container",children:m.jsxs("table",{className:"admin-table",children:[m.jsx("thead",{children:m.jsxs("tr",{children:[m.jsx("th",{children:"Order ID"}),m.jsx("th",{children:"Date"}),m.jsx("th",{children:"Customer"}),m.jsx("th",{children:"Items"}),m.jsx("th",{children:"Total"}),m.jsx("th",{children:"Status"}),m.jsx("th",{children:"Action"})]})}),m.jsx("tbody",{children:s.map(y=>m.jsxs("tr",{children:[m.jsxs("td",{style:{fontSize:"0.8rem",color:"var(--text-muted)"},children:[y.id.slice(0,8),"..."]}),m.jsx("td",{children:new Date(y.date).toLocaleDateString()}),m.jsxs("td",{children:[m.jsx("strong",{children:y.customer.fullName}),m.jsx("br",{}),m.jsxs("span",{style:{fontSize:"0.8rem"},children:[y.customer.city,", ",y.customer.zipCode]})]}),m.jsxs("td",{children:[y.items.length," items"]}),m.jsx("td",{children:m.jsxs("strong",{children:["₹",y.total]})}),m.jsx("td",{children:m.jsx("span",{style:{padding:"4px 8px",borderRadius:"4px",fontSize:"0.8rem",backgroundColor:y.status==="Pending"?"#fff3cd":"#d4edda",color:y.status==="Pending"?"#856404":"#155724"},children:y.status})}),m.jsx("td",{children:y.status==="Pending"?m.jsx("button",{onClick:()=>l(y.id,"Shipped"),className:"btn-primary",style:{padding:"5px 10px",fontSize:"0.8rem"},children:"Mark Shipped"}):m.jsx("button",{onClick:()=>l(y.id,"Pending"),className:"btn-secondary",style:{padding:"5px 10px",fontSize:"0.8rem"},children:"Mark Pending"})})]},y.id))})]})})]}),u==="products"&&m.jsxs("div",{className:"admin-grid",children:[m.jsxs("div",{className:"admin-card",children:[m.jsx("h2",{children:"Add New Product"}),m.jsxs("form",{onSubmit:S,className:"admin-form",children:[m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Product Title"}),m.jsx("input",{type:"text",name:"title",value:d.title,onChange:N,placeholder:"e.g. Royal Silk Dhoti",required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Price (₹)"}),m.jsx("input",{type:"number",name:"price",value:d.price,onChange:N,placeholder:"e.g. 1500",required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Category"}),m.jsxs("select",{name:"category",value:d.category,onChange:N,children:[m.jsx("option",{value:"Dhotis",children:"Dhotis"}),m.jsx("option",{value:"Shirts",children:"Shirts"}),m.jsx("option",{value:"Accessories",children:"Accessories"})]})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Product Image"}),m.jsx("input",{type:"file",id:"productImageInput",accept:"image/*",onChange:w,required:!0})]}),m.jsx("button",{type:"submit",className:"btn-primary w-100",disabled:x,children:x?"Uploading Image...":"Add Product"})]})]}),m.jsxs("div",{className:"admin-card",children:[m.jsxs("h2",{children:["Current Products (",t.length,")"]}),m.jsx("div",{className:"product-list-container",children:m.jsxs("table",{className:"admin-table",children:[m.jsx("thead",{children:m.jsxs("tr",{children:[m.jsx("th",{children:"Image"}),m.jsx("th",{children:"Title"}),m.jsx("th",{children:"Price"}),m.jsx("th",{children:"Category"}),m.jsx("th",{children:"Action"})]})}),m.jsx("tbody",{children:t.map(y=>m.jsxs("tr",{children:[m.jsx("td",{children:m.jsx("img",{src:y.image,alt:y.title,className:"admin-table-img"})}),m.jsx("td",{children:y.title}),m.jsxs("td",{children:["₹",y.price]}),m.jsx("td",{children:y.category}),m.jsx("td",{children:m.jsx("button",{onClick:()=>n(y.id),className:"btn-delete",children:"Delete"})})]},y.id))})]})})]})]}),u==="settings"&&m.jsxs("div",{className:"admin-card",children:[m.jsx("h2",{children:"Store Settings (Footer Content)"}),m.jsxs("form",{onSubmit:E,className:"admin-form",style:{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:"20px"},children:[m.jsxs("div",{className:"form-group",style:{gridColumn:"1 / -1"},children:[m.jsx("label",{children:"Company Description"}),m.jsx("input",{type:"text",name:"description",value:b.description,onChange:F,required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Contact Email"}),m.jsx("input",{type:"email",name:"email",value:b.email,onChange:F,required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Contact Phone"}),m.jsx("input",{type:"text",name:"phone",value:b.phone,onChange:F,required:!0})]}),m.jsx("div",{className:"form-group",style:{display:"flex",alignItems:"flex-end",gridColumn:"1 / -1"},children:m.jsx("button",{type:"submit",className:"btn-primary",style:{width:"200px"},children:"Save Settings"})})]})]})]})})},jV=()=>{const[t,e]=P.useState(""),[n,r]=P.useState(""),[i,s]=P.useState(""),{login:o}=P.useContext(Qn),l=Ri(),u=async c=>{c.preventDefault(),s("");try{await o(t,n),l(t==="murthythiru97@gmail.com"?"/admin":"/shop")}catch(d){s("Failed to log in. Please check your credentials."),console.error(d)}};return m.jsx("div",{className:"section-padding",style:{display:"flex",justifyContent:"center",minHeight:"80vh",alignItems:"center",backgroundColor:"var(--bg-light)"},children:m.jsxs("div",{className:"admin-card",style:{maxWidth:"400px",width:"100%"},children:[m.jsx("h2",{style:{textAlign:"center",marginBottom:"20px"},children:"Welcome Back"}),i&&m.jsx("div",{style:{color:"#dc3545",marginBottom:"15px",padding:"10px",background:"#f8d7da",borderRadius:"4px"},children:i}),m.jsxs("form",{onSubmit:u,className:"admin-form",children:[m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Email"}),m.jsx("input",{type:"email",value:t,onChange:c=>e(c.target.value),required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Password"}),m.jsx("input",{type:"password",value:n,onChange:c=>r(c.target.value),required:!0})]}),m.jsx("button",{type:"submit",className:"btn-primary w-100",style:{marginTop:"10px"},children:"Log In"})]}),m.jsxs("div",{style:{textAlign:"center",marginTop:"20px",fontSize:"0.9rem"},children:["Don't have an account? ",m.jsx(fe,{to:"/signup",style:{color:"var(--primary-color)",fontWeight:"bold"},children:"Sign Up"})]})]})})},FV=()=>{const[t,e]=P.useState(""),[n,r]=P.useState(""),[i,s]=P.useState(""),[o,l]=P.useState(""),{signup:u}=P.useContext(Qn),c=Ri(),d=async f=>{if(f.preventDefault(),l(""),n!==i)return l("Passwords do not match.");try{await u(t,n),c("/shop")}catch(g){l("Failed to create an account. "+g.message),console.error(g)}};return m.jsx("div",{className:"section-padding",style:{display:"flex",justifyContent:"center",minHeight:"80vh",alignItems:"center",backgroundColor:"var(--bg-light)"},children:m.jsxs("div",{className:"admin-card",style:{maxWidth:"400px",width:"100%"},children:[m.jsx("h2",{style:{textAlign:"center",marginBottom:"20px"},children:"Create an Account"}),o&&m.jsx("div",{style:{color:"#dc3545",marginBottom:"15px",padding:"10px",background:"#f8d7da",borderRadius:"4px"},children:o}),m.jsxs("form",{onSubmit:d,className:"admin-form",children:[m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Email Address"}),m.jsx("input",{type:"email",value:t,onChange:f=>e(f.target.value),required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Password"}),m.jsx("input",{type:"password",value:n,onChange:f=>r(f.target.value),required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Confirm Password"}),m.jsx("input",{type:"password",value:i,onChange:f=>s(f.target.value),required:!0})]}),m.jsx("button",{type:"submit",className:"btn-primary w-100",style:{marginTop:"10px"},children:"Sign Up"})]}),m.jsxs("div",{style:{textAlign:"center",marginTop:"20px",fontSize:"0.9rem"},children:["Already have an account? ",m.jsx(fe,{to:"/login",style:{color:"var(--primary-color)",fontWeight:"bold"},children:"Log In"})]})]})})},UV=()=>{const{isCartOpen:t,toggleCart:e,cartItems:n,removeFromCart:r,updateQuantity:i,cartTotal:s}=P.useContext(Us),o=Ri(),l=()=>{n.length!==0&&(e(),o("/checkout"))};return m.jsxs(m.Fragment,{children:[t&&m.jsx("div",{className:"cart-backdrop",onClick:e}),m.jsxs("div",{className:`cart-sidebar ${t?"open":""}`,children:[m.jsxs("div",{className:"cart-header",children:[m.jsx("h2",{children:"Your Cart"}),m.jsx("button",{className:"close-cart-btn",onClick:e,"aria-label":"Close Cart",children:m.jsx(JE,{size:24})})]}),m.jsx("div",{className:"cart-items-container",children:n.length===0?m.jsxs("div",{className:"empty-cart",children:[m.jsx("p",{children:"Your cart is empty."}),m.jsx("button",{className:"btn-secondary",onClick:e,style:{marginTop:"20px"},children:"Continue Shopping"})]}):n.map(u=>m.jsxs("div",{className:"cart-item",children:[m.jsx("img",{src:u.image,alt:u.title,className:"cart-item-img"}),m.jsxs("div",{className:"cart-item-details",children:[m.jsx("h4",{className:"cart-item-title",children:u.title}),m.jsxs("p",{className:"cart-item-price",children:["₹",u.price]}),m.jsxs("div",{className:"cart-item-actions",children:[m.jsxs("div",{className:"quantity-controls",children:[m.jsx("button",{onClick:()=>i(u.id,-1),disabled:u.quantity<=1,children:m.jsx(ex,{size:14})}),m.jsx("span",{children:u.quantity}),m.jsx("button",{onClick:()=>i(u.id,1),children:m.jsx(X1,{size:14})})]}),m.jsx("button",{className:"remove-item-btn",onClick:()=>r(u.id),title:"Remove Item",children:m.jsx(G1,{size:16})})]})]})]},u.id))}),n.length>0&&m.jsxs("div",{className:"cart-footer",children:[m.jsxs("div",{className:"cart-total",children:[m.jsx("span",{children:"Subtotal"}),m.jsxs("span",{children:["₹",s]})]}),m.jsx("button",{className:"btn-primary checkout-btn",onClick:l,children:"Checkout"})]})]})]})},BV=()=>{const n=`https://wa.me/919080056621?text=${encodeURIComponent("Hello Ramanaa! I have a question about your products.")}`;return m.jsx("a",{href:n,target:"_blank",rel:"noopener noreferrer",className:"whatsapp-float","aria-label":"Chat with us on WhatsApp",children:m.jsx("svg",{viewBox:"0 0 24 24",width:"32",height:"32",fill:"white",children:m.jsx("path",{d:"M12.031 0C5.385 0 0 5.385 0 12.031c0 2.658.835 5.143 2.308 7.234L.548 24l4.88-1.28c2.033 1.34 4.417 2.052 6.945 2.052 6.646 0 12.031-5.385 12.031-12.031S18.677 0 12.031 0zm0 22.753c-2.28 0-4.512-.596-6.467-1.721l-.464-.275-3.626.95.968-3.535-.302-.48C.913 15.65 0 13.882 0 12.031 0 6.514 4.486 2.028 10.003 2.028c5.514 0 10 4.486 10 10s-4.486 10-10 10zm5.498-7.514c-.302-.151-1.782-.88-2.058-.98-.276-.101-.478-.151-.678.151-.201.302-.78 .98-.956 1.181-.176.201-.352.226-.653.075-.302-.151-1.272-.469-2.423-1.498-.895-.801-1.5-1.79-1.676-2.091-.176-.302-.019-.465.132-.616.136-.136.302-.352.453-.528.151-.176.201-.302.302-.503.101-.201.05-.377-.025-.528-.075-.151-.678-1.634-.93-2.238-.246-.59-.496-.51-.678-.52-.176-.01-.377-.01-.578-.01-.201 0-.528.075-.804.377-.276.302-1.055 1.03-1.055 2.513 0 1.483 1.08 2.915 1.231 3.116.151.201 2.124 3.242 5.143 4.543.718.309 1.28.494 1.716.632.721.229 1.378.197 1.895.119.578-.087 1.782-.729 2.033-1.432.251-.703.251-1.307.176-1.432-.075-.125-.276-.2-.578-.351z"})})})},zV=()=>{const{id:t}=HC(),{products:e,addReview:n}=P.useContext(Da),{addToCart:r}=P.useContext(Us),{currentUser:i}=P.useContext(Qn),[s,o]=P.useState(null),[l,u]=P.useState("M"),[c,d]=P.useState(5),[f,g]=P.useState(""),[T,x]=P.useState(!1);if(P.useEffect(()=>{const b=e.find(V=>V.id.toString()===t);o(b)},[t,e]),!s)return m.jsxs("div",{className:"product-details-page section-padding text-center",children:[m.jsx("h2",{children:"Loading Product..."}),m.jsx(fe,{to:"/shop",className:"btn-secondary",style:{marginTop:"20px"},children:"Back to Shop"})]});const k=()=>{r({...s,selectedSize:s.category==="Shirts"?l:null})},N=async b=>{if(b.preventDefault(),!i)return alert("You must be logged in to review.");if(!f.trim())return alert("Please write a review.");x(!0);try{const V={rating:c,text:f,author:i.email.split("@")[0],date:new Date().toISOString()};await n(s.id,V),g(""),d(5),alert("Review submitted successfully!")}catch(V){console.error(V),alert("Failed to submit review.")}finally{x(!1)}},w=s.category==="Shirts",v=["S","M","L","XL"],S=s.reviews||[];return m.jsx("div",{className:"product-details-page section-padding",children:m.jsxs("div",{className:"container",children:[m.jsxs(fe,{to:"/shop",className:"back-link",children:[m.jsx(ox,{})," Back to Collection"]}),m.jsxs("div",{className:"details-grid",children:[m.jsx("div",{className:"details-image-container",children:m.jsx("img",{src:s.image,alt:s.title,className:"details-image"})}),m.jsxs("div",{className:"details-info",children:[m.jsx("p",{className:"details-category",children:s.category}),m.jsx("h1",{className:"details-title",children:s.title}),S.length>0&&m.jsxs("div",{style:{color:"var(--secondary-color)",marginBottom:"15px"},children:["★ ",(S.reduce((b,V)=>b+V.rating,0)/S.length).toFixed(1),m.jsxs("span",{style:{color:"var(--text-muted)",fontSize:"0.9rem"},children:[" (",S.length," reviews)"]})]}),m.jsxs("p",{className:"details-price",children:["₹",s.price]}),m.jsxs("div",{className:"details-description",children:[m.jsx("h3",{children:"Description"}),m.jsxs("p",{children:["Experience the ultimate comfort and elegance with this premium ",s.category.toLowerCase().slice(0,-1),". Carefully crafted with high-quality materials to provide a luxurious feel and a perfect fit. Whether for a traditional ceremony or a sophisticated gathering, this piece from Ramanaa is designed to make you stand out."]}),m.jsxs("ul",{className:"details-features",children:[m.jsx("li",{children:"Premium breathable fabric"}),m.jsx("li",{children:"Authentic traditional design"}),m.jsx("li",{children:"Comfortable all-day wear"})]})]}),w&&m.jsxs("div",{className:"details-sizes",children:[m.jsx("h3",{children:"Select Size"}),m.jsx("div",{className:"size-selector",children:v.map(b=>m.jsx("button",{className:`size-btn ${l===b?"active":""}`,onClick:()=>u(b),children:b},b))})]}),m.jsxs("button",{className:"btn-primary add-cart-large-btn",onClick:k,children:["Add to Cart - ₹",s.price]})]})]}),m.jsxs("div",{style:{marginTop:"60px",paddingTop:"40px",borderTop:"1px solid var(--border-color)"},children:[m.jsx("h2",{className:"section-title",style:{fontSize:"2rem"},children:"Customer Reviews"}),m.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr",gap:"40px"},children:[m.jsx("div",{children:S.length===0?m.jsx("p",{style:{color:"var(--text-muted)"},children:"No reviews yet. Be the first to review this product!"}):m.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:S.map((b,V)=>m.jsxs("div",{style:{padding:"20px",backgroundColor:"var(--bg-white)",borderRadius:"8px",boxShadow:"var(--shadow-sm)"},children:[m.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:"10px"},children:[m.jsx("strong",{children:b.author}),m.jsx("span",{style:{color:"var(--text-muted)",fontSize:"0.9rem"},children:new Date(b.date).toLocaleDateString()})]}),m.jsxs("div",{style:{color:"var(--secondary-color)",marginBottom:"10px"},children:["★".repeat(b.rating),"☆".repeat(5-b.rating)]}),m.jsx("p",{style:{color:"var(--text-dark)"},children:b.text})]},V))})}),m.jsxs("div",{style:{backgroundColor:"var(--bg-white)",padding:"30px",borderRadius:"8px",boxShadow:"var(--shadow-sm)"},children:[m.jsx("h3",{style:{fontFamily:"var(--font-heading)",marginBottom:"20px"},children:"Write a Review"}),i?m.jsxs("form",{onSubmit:N,children:[m.jsxs("div",{style:{marginBottom:"15px"},children:[m.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Rating"}),m.jsx("div",{style:{display:"flex",gap:"10px"},children:[1,2,3,4,5].map(b=>m.jsx("button",{type:"button",onClick:()=>d(b),style:{background:"none",border:"none",fontSize:"1.5rem",color:b<=c?"var(--secondary-color)":"#ccc"},children:"★"},b))})]}),m.jsxs("div",{style:{marginBottom:"15px"},children:[m.jsx("label",{style:{display:"block",marginBottom:"8px",fontWeight:"500"},children:"Your Review"}),m.jsx("textarea",{rows:"4",value:f,onChange:b=>g(b.target.value),style:{width:"100%",padding:"10px",borderRadius:"4px",border:"1px solid var(--border-color)",backgroundColor:"transparent",color:"var(--text-dark)"},placeholder:"What did you like about this product?",required:!0})]}),m.jsx("button",{type:"submit",className:"btn-primary",disabled:T,children:T?"Submitting...":"Submit Review"})]}):m.jsxs("p",{style:{color:"var(--text-muted)"},children:["You must ",m.jsx(fe,{to:"/login",style:{color:"var(--primary-color)",textDecoration:"underline"},children:"log in"})," to write a review."]})]})]})]})]})})},$V=()=>{const{cartItems:t,cartTotal:e,clearCart:n}=P.useContext(Us),{placeOrder:r}=P.useContext(Pc),{currentUser:i}=P.useContext(Qn),s=Ri(),[o,l]=P.useState({fullName:"",email:i?i.email:"",phone:"",address:"",city:"",zipCode:""}),[u,c]=P.useState(!1);if(t.length===0)return m.jsxs("div",{className:"checkout-page section-padding text-center",children:[m.jsx("h2",{children:"Your cart is empty!"}),m.jsx("button",{className:"btn-primary",onClick:()=>s("/shop"),style:{marginTop:"20px"},children:"Return to Shop"})]});const d=g=>{l({...o,[g.target.name]:g.target.value})},f=async g=>{g.preventDefault(),c(!0);try{await r({customer:o,items:t,total:e}),n(),alert("Order placed successfully! Thank you for shopping with Ramanaa."),s("/")}catch(T){console.error(T),alert("There was an error placing your order.")}finally{c(!1)}};return m.jsx("div",{className:"checkout-page section-padding",children:m.jsxs("div",{className:"container",children:[m.jsx("h1",{className:"section-title",children:"Checkout"}),m.jsxs("div",{className:"checkout-grid",children:[m.jsxs("div",{className:"checkout-form-container",children:[m.jsx("h2",{children:"Shipping Information"}),m.jsxs("form",{onSubmit:f,className:"checkout-form",children:[m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Full Name"}),m.jsx("input",{type:"text",name:"fullName",value:o.fullName,onChange:d,required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Email Address"}),m.jsx("input",{type:"email",name:"email",value:o.email,onChange:d,required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Phone Number"}),m.jsx("input",{type:"tel",name:"phone",value:o.phone,onChange:d,required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"Shipping Address"}),m.jsx("textarea",{name:"address",rows:"3",value:o.address,onChange:d,required:!0})]}),m.jsxs("div",{className:"form-row",children:[m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"City"}),m.jsx("input",{type:"text",name:"city",value:o.city,onChange:d,required:!0})]}),m.jsxs("div",{className:"form-group",children:[m.jsx("label",{children:"PIN Code"}),m.jsx("input",{type:"text",name:"zipCode",value:o.zipCode,onChange:d,required:!0})]})]}),m.jsx("button",{type:"submit",className:"btn-primary w-100 place-order-btn",disabled:u,children:u?"Processing Order...":`Place Order • ₹${e}`})]})]}),m.jsxs("div",{className:"checkout-summary",children:[m.jsx("h2",{children:"Order Summary"}),m.jsx("div",{className:"summary-items",children:t.map(g=>m.jsxs("div",{className:"summary-item",children:[m.jsx("div",{className:"summary-item-img",children:m.jsx("img",{src:g.image,alt:g.title})}),m.jsxs("div",{className:"summary-item-info",children:[m.jsx("h4",{children:g.title}),g.selectedSize&&m.jsxs("p",{children:["Size: ",g.selectedSize]}),m.jsxs("p",{children:["Qty: ",g.quantity]})]}),m.jsxs("div",{className:"summary-item-price",children:["₹",g.price*g.quantity]})]},`${g.id}-${g.selectedSize}`))}),m.jsxs("div",{className:"summary-totals",children:[m.jsxs("div",{className:"summary-row",children:[m.jsx("span",{children:"Subtotal"}),m.jsxs("span",{children:["₹",e]})]}),m.jsxs("div",{className:"summary-row",children:[m.jsx("span",{children:"Shipping"}),m.jsx("span",{children:"Free"})]}),m.jsxs("div",{className:"summary-row total",children:[m.jsx("span",{children:"Total"}),m.jsxs("span",{children:["₹",e]})]})]})]})]})]})})},WV=()=>{const{currentUser:t,logout:e}=P.useContext(Qn),{orders:n}=P.useContext(Pc),r=n.filter(i=>i.customer&&i.customer.email===t.email);return m.jsx("div",{className:"section-padding",style:{backgroundColor:"var(--bg-light)",minHeight:"100vh",paddingTop:"120px"},children:m.jsxs("div",{className:"container",style:{maxWidth:"900px"},children:[m.jsxs("div",{style:{backgroundColor:"var(--bg-white)",padding:"30px",borderRadius:"12px",boxShadow:"var(--shadow-sm)",marginBottom:"30px",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[m.jsxs("div",{children:[m.jsx("h1",{style:{fontFamily:"var(--font-heading)",color:"var(--primary-color)",marginBottom:"5px"},children:"My Profile"}),m.jsxs("p",{style:{color:"var(--text-muted)"},children:["Welcome back, ",m.jsx("strong",{children:t.email})]})]}),m.jsx("button",{onClick:e,className:"btn-secondary",children:"Sign Out"})]}),m.jsx("h2",{style:{fontFamily:"var(--font-heading)",marginBottom:"20px"},children:"Order History"}),r.length===0?m.jsxs("div",{style:{backgroundColor:"var(--bg-white)",padding:"40px",borderRadius:"12px",boxShadow:"var(--shadow-sm)",textAlign:"center"},children:[m.jsx(sx,{size:48,color:"var(--text-muted)",style:{marginBottom:"15px"}}),m.jsx("h3",{children:"No Orders Yet"}),m.jsx("p",{style:{color:"var(--text-muted)",marginBottom:"20px"},children:"You haven't placed any orders with us yet."}),m.jsx(fe,{to:"/shop",className:"btn-primary",children:"Start Shopping"})]}):m.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:r.map(i=>m.jsxs("div",{style:{backgroundColor:"var(--bg-white)",padding:"25px",borderRadius:"12px",boxShadow:"var(--shadow-sm)"},children:[m.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",borderBottom:"1px solid var(--border-color)",paddingBottom:"15px",marginBottom:"15px"},children:[m.jsxs("div",{children:[m.jsxs("span",{style:{fontSize:"0.85rem",color:"var(--text-muted)",textTransform:"uppercase",letterSpacing:"1px"},children:["Order ID: ",i.id]}),m.jsx("h4",{style:{marginTop:"5px"},children:new Date(i.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})})]}),m.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",fontWeight:"bold",color:i.status==="Shipped"?"var(--success-color)":"var(--secondary-color)"},children:[i.status==="Shipped"?m.jsx(ix,{}):m.jsx(rx,{}),i.status]})]}),m.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[m.jsxs("div",{children:[m.jsxs("p",{style:{color:"var(--text-muted)",marginBottom:"5px"},children:[i.items.length," ",i.items.length===1?"item":"items"]}),m.jsx("div",{style:{display:"flex",gap:"10px"},children:i.items.map((s,o)=>m.jsx("div",{style:{width:"40px",height:"40px",borderRadius:"4px",overflow:"hidden",border:"1px solid var(--border-color)"},children:m.jsx("img",{src:s.image,alt:s.title,style:{width:"100%",height:"100%",objectFit:"cover"}})},o))})]}),m.jsxs("div",{style:{textAlign:"right"},children:[m.jsx("span",{style:{fontSize:"0.9rem",color:"var(--text-muted)"},children:"Total Amount"}),m.jsxs("h3",{style:{color:"var(--primary-color)"},children:["₹",i.total]})]})]})]},i.id))})]})})},HV=({children:t})=>{const{isAdmin:e,loading:n}=P.useContext(Qn);return n?m.jsx("div",{style:{padding:"100px",textAlign:"center"},children:"Loading..."}):e?t:m.jsx(HE,{to:"/shop"})},qV=({children:t})=>{const{currentUser:e,loading:n}=P.useContext(Qn);return n?m.jsx("div",{style:{padding:"100px",textAlign:"center"},children:"Loading..."}):e?t:m.jsx(HE,{to:"/login"})};function KV(){return m.jsx(xV,{children:m.jsx(AV,{children:m.jsx(PV,{children:m.jsx(bV,{children:m.jsx(VV,{children:m.jsx(CV,{children:m.jsx(P1,{children:m.jsxs("div",{className:"app-container",children:[m.jsx(kV,{}),m.jsx(UV,{}),m.jsx("main",{className:"main-content",children:m.jsxs(o1,{children:[m.jsx(Cn,{path:"/",element:m.jsx(OV,{})}),m.jsx(Cn,{path:"/shop",element:m.jsx(LV,{})}),m.jsx(Cn,{path:"/product/:id",element:m.jsx(zV,{})}),m.jsx(Cn,{path:"/checkout",element:m.jsx($V,{})}),m.jsx(Cn,{path:"/login",element:m.jsx(jV,{})}),m.jsx(Cn,{path:"/signup",element:m.jsx(FV,{})}),m.jsx(Cn,{path:"/profile",element:m.jsx(qV,{children:m.jsx(WV,{})})}),m.jsx(Cn,{path:"/admin",element:m.jsx(HV,{children:m.jsx(MV,{})})})]})}),m.jsx(BV,{}),m.jsx(NV,{})]})})})})})})})})}kE(document.getElementById("root")).render(m.jsx(P.StrictMode,{children:m.jsx(KV,{})}));
